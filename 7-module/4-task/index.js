export default class StepSlider {
  ...
  render() {
    ...
    //обработчик изменения значения по слайду
    sliderThumbDiv.ondragstart = () => false;
    sliderThumbDiv.pointerdown = () => false;
    sliderThumbDiv.pointermove = () => false;

    let segments = this.steps - 1;

    sliderThumbDiv.onpointerdown = function(ev) {

      // sliderThumbDiv.classList.add('slider_dragging');
      
      function onMouseMove(ev) {
        // sliderThumbDiv.classList.add('slider_dragging');
        sliderDiv.classList.add('slider_dragging');
        ...
        sliderProgressDiv.style.width = ( leftPercents + '%');
        sliderThumbDiv.style.left = ( leftPercents + '%');
      ...
      document.onpointerup = function(ev) {
        ...
        // sliderThumbDiv.classList.remove('slider_dragging');
        ...
        // sliderThumbDiv.classList.remove('slider_dragging');
        sliderDiv.classList.remove('slider_dragging');
    ...
    //обработчик изменения значения по клику
